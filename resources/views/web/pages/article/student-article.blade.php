                        ...
                        <div class="p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-600">9th grader</p>
                                </div>
                            </div>
                            <h4 class="text-xl font-bold text-gray-800 mb-3 line-clamp-2">
                                How students overcome challenges and grow through learning.
                            </h4>
                            <p class="text-gray-600 text-sm mb-4 line-clamp-3">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis dolores vitae sed quod
                                dolorem aut, repudiandae dolore corporis aspernatur veritatis commodi ipsam dolorum
                                expedita saepe maxime vel animi sit a?
                            </p>
