...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div
            ...
            <div class="flex items-start justify-between">
                <div class="space-y-2">
                    <p class="text-sm font-medium text-[#65758b]">Total Students</p>
                    <p class="text-3xl font-bold tracking-tight">
                        1,284
                    </p>
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-xs text-gray-500">new Students this month</span>
                    </div>

                </div>
                <div
                    class="rounded-2xl bg-blue-500 text-white p-3 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg shadow-[#6547fa1a]">
                    <img src="{{ asset('assets/svg/book-user-white.svg') }}">
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <button
                    ...
                    View All
                    <img src="{{ asset('assets/svg/arrow-right.svg') }}" class="w-4 h-4 ml-1">
                </button>
            </div>
        </div>
