                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="p-4">
                                <img src="https://images.ctfassets.net/h6goo9gw1hh6/2sNZtFAWOdP1lmQ33VwRN3/24e953b920a9cd0ff2e1d587742a2472/1-intro-photo-final.jpg?w=1200&h=992&fl=progressive&q=70&fm=jpg"
                                    class="w-8 h-8 rounded-full object-cover" alt="Admin Profile">
                            </td>
                            <td class="p-4 text-sm text-gray-700">
                                amit_admin
                            </td>
                            <td class="p-4 text-sm text-gray-700">
                                <a href="mailto:demo@gmail.com" class="hover:underline">
                                    demo@gmail.com
                                </a>
                            </td>

                            <td class="p-4 text-sm text-gray-700">
                                <a href="tel:+977872899893434" class="hover:underline">
                                    +977872899893434
                                </a>
                            </td>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select
                                        ...
                                        <option value="completed">Super Admin</option>
