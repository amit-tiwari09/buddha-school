        ...
        <div class="rounded-sm shadow-md border border-gray-200">
            <div class="border-b border-gray-200">
                ...
                <form class="p-2 border-b border-gray-200">
                    <div
                        class="grid grid-cols-4  gap-3 xl:gap-0 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-3 border border-gray-200 shadow-sm">
                        <div
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select
                                        ...
                                        <option value="completed">Seminar</option>
                                        <option value="pending">Workshop</option>
                                        <option value="processing">Confrence</option>
                                    </select>
                        ...
                        <div class="col-span-4 xl:col-span-1  flex items-end justify-end">
                            <div class="flex gap-2">
                                ...
                                <button type="button" data-targetModalId="event-add-modal"
                ...
                <table class="w-full caption-bottom text-sm ">
                    <thead>
                        <tr class="border-b border-gray-200">
                            ...
                            <th class="h-12 px-4 text-left font-semibold">Event Name</th>
                            <th class="h-12 px-4 text-left font-semibold">Event Type</th>
                            <th class="h-12 px-4 text-left font-semibold">Event At</th>
                            <th class="h-12 px-4 text-left font-semibold">Organizer</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="p-4">2026-01-15 10:00 AM</td>
                            <td class="p-4">No one</td>
                            <td class="p-4">Main Hospital Auditorium</td>
                            <td class="p-4 flex items-center space-x-1">
                                <div class="flex items-center justify-start space-x-1">
                                    <button
                                        class="flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium  rounded-md h-4 w-4 p-0">
                                    ...
                                    <button
                                        class="flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium  rounded-md h-4 w-4 p-0">
                                        <img src="{{ asset('assets/svg/bin.svg') }}" class="w-4 h-4 pointer-events-none"
                                            alt="">
                                    </button>
                                </div>
                            </td>
